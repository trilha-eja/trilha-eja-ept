    ...
    <div>
      ...
      <div className="max-w-lg mx-auto px-4 py-5 pb-10 space-y-4">
        <div className="bg-chart-5/10 border border-chart-5/20 rounded-2xl p-4">
          <p className="text-sm leading-relaxed text-foreground">Ao clicar em <strong>"Ver vídeos"</strong>, o YouTube abrirá com uma busca já feita sobre o tema. Escolha o vídeo que parecer mais claro para você!</p>
        </div>
        <AbaVideos />
