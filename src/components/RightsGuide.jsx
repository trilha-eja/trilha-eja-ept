...
const subpaginas = [
  ...
  },
  {
    ...
    intro: <>O <strong>INSS</strong> existe para proteger o(a) trabalhador(a) em momentos difíceis — doença, acidente, maternidade e aposentadoria. Conheça seus direitos previdenciários.</>,
  ...
  },
  {
    ...
    intro: <>Os direitos coletivos existem porque <strong>trabalhadores(as) unidos(as)</strong> conquistaram mais ao longo da história. Conheça seus direitos coletivos e saiba onde buscar apoio.</>,
